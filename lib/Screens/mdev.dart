...
class MDev extends StatefulWidget {
  @override
  _MDevState createState() => _MDevState();
}

class _MDevState extends State<MDev> {
          ...
          children: [
            ...
            Container(
                ...
                child: MaterialButton(
                  onPressed: () async {
                    bool shouldNavigate = await SendMDevData(
                      _devname.text,
                      _devdesc.text,
                      _devemail.text,
                      _devphn.text,
